...
def check_and_set_default_args(command_args):
    if not(hasattr(command_args, 'train_shards')) or command_args.train_shards is None:#hasattr(object, name)判断object对象中是否存在name属性
...
def main(command_args):
    ...
    """
    check_and_set_default_args(command_args)#检查参数设置
