...
if __name__ == "__main__":
  ...
  parser.add_argument(
      "--input_graph",
      type=str,
      default="C:\\project-dl\\cell-fenlei\\export\\mobilenet_v2_inf_graph.pb",
  ...
  parser.add_argument(
      "--input_checkpoint",
      type=str,
      default="C:\\project-dl\\cell-fenlei\\train_dir\\model.ckpt-327486",
      help="TensorFlow variables file to load.")
  parser.add_argument(
      "--output_graph",
      type=str,
      default="C:\\project-dl\\cell-fenlei\\export\\mobilenetv2_frozen_graph_cell.pb",
  ...
  parser.add_argument(
      "--output_node_names",
      type=str,
      default="MobilenetV2/Predictions/Reshape_1",#修改
